    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p>
            ...
            From fashion and beasty to electronics and home essentials, we offer an extensive collection sourced from trusted brands and suppliers.
          </p>
          <b className="text-gray-800">Our Mission</b>
          <p>Our mission at Forever is to empower customers with choice,covenience,and confidence.We're dedicated to providing a seamless shopping experoence that exceeds expectations ,from browsing and ordering to delivery and beyond </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20">
        <div className=" border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">We meticulously select and vet eash product to ensure it meets our stringent quality standards.  </p>
